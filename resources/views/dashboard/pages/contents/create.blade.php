                ...
                <form action="{{ route('dashboard.contents.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingnameInput" name="title" placeholder="@lang('title')" value="{{ old('title') }}">
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control" id="floatingnameInput" name="value" placeholder="@lang('value')" cols="30" rows="10">{{ old('value') }}</textarea>
