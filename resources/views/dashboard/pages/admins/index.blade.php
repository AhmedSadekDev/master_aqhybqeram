...
<div style=" margin-bottom: 14px; position: relative; text-align: left; ">
    <a type="button" class="btn btn-primary"  href="{{route('dashboard.admins.create')}}">@lang('Create new admins')</a>
    <button
                    ...
                    <table class="table project-list-table table-nowrap align-middle table-borderless">
                        ...
                        <tbody>
                            @foreach ($lists as $list)
                                <tr>
                                    <td>
                                        <a href="{{ route('dashboard.admins.edit',$list->id) }}">
                                            {{ $list->first_name ?? '' }}
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td style="display: inline-flex;">
                                        <a style="margin-left: 5px;"
                                            ...
                                            href="{{ route('dashboard.admins.edit',$list->id) }}">
                                            <i class="bx bx-pencil"></i>
                                        </a>
                                        {!! action_table_delete(route('dashboard.admins.destroy',$list->id),$list->id) !!}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
...
<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptionsFilter" aria-labelledby="offcanvasWithBothOptionsLabel">
    ...
    <div class="offcanvas-body">
        <form action="{{ route('dashboard.admins.index') }}" method="get" enctype="multipart/form-data">
            ...
            <div class="row" style=" margin-top: 20px; ">
                <div style="text-align: right">
                    <a href="{{ route('dashboard.admins.index') }}" style=" float: left; " class="btn btn-primary w-md">
                        @lang('Reset')
                    </a>
