            ...
            <div class="card-body">
                ...
                <form action="{{ route('dashboard.subscriptions.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingnameInput" value="{{ old('name') }}" name="name" placeholder="@lang('Subscription Name')" />
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="floatingStore_DescInput" value="{{ old('price') }}" name="price" placeholder="@lang('Subscription Price')" />
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="floatingMonthInput" value="{{ old('month') }}" name="month" placeholder="@lang('Subscription Month')" />
