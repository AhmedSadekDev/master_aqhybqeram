    ...
    <div class="col-8 mx-auto mt-3">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('dashboard.intros.update',$intro->id) }}" method="post" enctype="multipart/form-data">

                    <div class="row">

                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" value="{{ old('name',$intro->name) }}" id="floatingnameInput" name="name" placeholder="@lang('Name')" />
