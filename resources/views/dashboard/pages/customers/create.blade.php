            ...
            <div class="card-body">
                ...
                <form action="{{ route('dashboard.customers.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingfirst_nameInput" name="first_name" placeholder="@lang('الإسم الأول')" />
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatinglast_nameInput" name="last_name" placeholder="@lang('الإسم الأخير')" />
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="floatingPhoneInput" name="phone" placeholder="@lang('الجوال')" />
