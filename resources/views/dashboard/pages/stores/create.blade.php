            ...
            <div class="card-body">
                ...
                <form action="{{ route('dashboard.stores.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingnameInput" value="{{ old('name') }}" name="name" placeholder="@lang('Store Name')" />
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingStore_DescInput" value="{{ old('desc') }}" name="desc" placeholder="@lang('Store Desc')" />
